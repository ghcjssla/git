...
import com.happylopers.board.service.ReplyService;
...
public class ReplyController {
    ...
    public ResponseEntity<String> update(@PathVariable("bno") Integer rno,
                                         @RequestBody ReplyVO vo){
        logger.info("/{bno}"+rno+" "+vo);
