	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class='box'>
				...
				<div class='box-body'>
					<button id='newBtn' onClick="javascript:test('register')">New Board</button>
				</div>
			</div>
			<div class="box">
				<div class="box-header with-border">
					...
					<table class="table table-bordered">
						...
						<c:forEach items="${list}" var="boardVO">
							...
							<tr>
								<td>${boardVO.bno}</td>
								<td><a
									href='/rootContext/board/readPage${pageMaker.makeQuery(pageMaker.cri.page) }&bno=${boardVO.bno}'>
										${boardVO.title}</a></td>
