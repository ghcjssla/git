...
--%>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-list-alt"></i> <span>스프링 게시판</span></a></li>
            <li class="active"><a href="#"><i class="fa fa-calendar"></i> <span>기상 일지</span></a></li>
            <li class="active"><a href="#"><i class="fa fa-book"></i> <span>책 일지</span></a></li>
            <%--
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
                                스프링 게시판
            <small>스프링 기반 게시판입니다.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-list-alt"></i> 스프링 게시판</a></li>
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">HAPPYLOPERS</a>.</strongs> All rights reserved.
      </footer>
