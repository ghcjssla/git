...
<html lang="ko">
  ...
  <body role="document">
    <div class="container theme-showcase" role="main">
      ...
      <p>
        <button type="button" class="btn btn-lg btn-success btn-block">기상</button>
          ...
          <table class="table table-striped table-hover table-bordered table-condensed ">
            ...
            <tbody>
              <tr>
                ...
                <td>오전 04:30 2016-01-03</td>
                <td class="text-center"><button type="button" class="btn btn-default">수정</button></td>
              </tr>
              <tr>
