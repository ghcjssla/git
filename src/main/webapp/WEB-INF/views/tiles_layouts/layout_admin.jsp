...
<title><%=UvPropUtil.getString("SITE_NAME")%> 관리자</title>
	...
	<!-- Bootstrap 3.3.6 -->
	<link rel="stylesheet" href="/admin/AdminLTE2/bootstrap/css/bootstrap.min.css">
	<!-- Font Awesome -->
...
<script type="text/javascript">
	...
	$(document).ajaxError(function(e, xhr, settings, exception) {
		...
		if (exception.indexOf("Unexpected token") > -1) {			
			location.reload();
		}
	});
...
<body class="hold-transition <%=UvUtil.toNotNull(UvSessionUtil.getSessionValueStr("AU_SKIN", request), "skin-blue")%> sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active" id="PROG_NAV1" style="display: none"></li>
					<li class="active" id="PROG_NAV2" style="display: none"></li>
				</ol>
			</section>
		...
		<aside class="control-sidebar control-sidebar-dark">
			<tiles:insertAttribute name="admin_control_sidebar" />
		</aside>
