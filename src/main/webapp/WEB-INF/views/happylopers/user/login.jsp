  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="/<spring:eval expression="@propGlobal['APP_ROOT']"></spring:eval>"><b>HAPPY</b>LOPERS</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">계정과 비밀번호를 입력하세요</p>

<form id="loginForm" action="/<spring:eval expression="@propGlobal['APP_ROOT']"></spring:eval>/user/loginPost" method="post">
  ...
  <div class="row">
    ...
    <div class="col-xs-4">
      <button type="submit" class="btn btn-primary btn-block btn-flat">Sign In</button>
        ...
        <!-- <a href="/<spring:eval expression="@propGlobal['APP_ROOT']"></spring:eval>/user/register" class="text-center">Register a new membership</a><span style="font-size:0.1em"></span> -->
        <a href="/<spring:eval expression="@propGlobal['APP_ROOT']"></spring:eval>/user/register" class="text-center">가입하기</a><span style="font-size:0.1em"></span>
	        ...
	        if (response.authResponse) {
	            FB.api('/me?fields=email,id,name', function(response) {
	            	if(false == checkDuplicatedUserWithFacebook(response.id)){
	            		...
	            		location.href="/<spring:eval expression="@propGlobal['APP_ROOT']"></spring:eval>/user/register";
	            	}else{
